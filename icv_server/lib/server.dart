import 'package:icv_server/src/birthday_reminder.dart';
import 'package:serverpod/serverpod.dart';

import 'package:icv_server/src/web/routes/root.dart';
...
void run(List<String> args) async {
  ...
  // TODO: Phase 11 - Configure authentication module for email/password and OAuth
  // Uncomment and configure when implementing authentication:
  //
  // import 'package:serverpod_auth_server/module.dart' as auth;
  //
  // auth.AuthConfig.set(auth.AuthConfig(
  //   sendValidationEmail: (session, email, validationCode) async {
  //     // Implement email sending using SMTP configuration from passwords.yaml
  //     // Access SMTP settings via: session.passwords['smtpHost'], etc.
