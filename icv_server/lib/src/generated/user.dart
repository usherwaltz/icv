...
class UserTable extends _i1.Table<int?> {
  UserTable({super.tableRelation}) : super(tableName: 'users') {
    ...
    themePreference = _i1.ColumnString(
      'themePreference',
      this,
    );
    cloudBackupEnabled = _i1.ColumnBool(
      'cloudBackupEnabled',
      this,
      hasDefault: true,
    );
    privacyPolicyAcceptedAt = _i1.ColumnDateTime(
      'privacyPolicyAcceptedAt',
      this,
    );
  ...
  late final _i1.ColumnEnum<_i2.AuthProvider> authProvider;

  late final _i1.ColumnString providerId;

  late final _i1.ColumnString themePreference;

  late final _i1.ColumnBool cloudBackupEnabled;

  late final _i1.ColumnDateTime privacyPolicyAcceptedAt;
